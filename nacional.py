...
class VeiculoNacional(Veiculo): # criar a classe VeiculoNacional herdando da classe Veiculo
    def __init__(self, placa, tipo, cor, nPortas, preco): # criar o construtor da classe VeiculoNacional herdando do construtor da classe Veiculo
